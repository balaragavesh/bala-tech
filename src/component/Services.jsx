...
export default function Services() {
  const serviceData = [
    {
      ...
      description: " Our comprehensive repair services encompass resolving intricate hardware issues, including screen replacements, keyboard repairs, battery replacements, and intricate motherboard fixes, coupled with adept software troubleshooting. We prioritize rapid diagnostics and efficient solutions to restore your laptop's functionality promptly, ensuring minimal downtime and seamless user experience.",
  ...
  return (
    <div className="py-28 w-full min-h-screen bg-white text-black">
      <h1 className="multicolor-text font-Montserrat text-6xl md:text-6xl font-bold text-center">
        Our Services
      </h1>
